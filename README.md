...
I got it. I finally got it. After nearly 2 years. I got it for real now. I can definitely code this within a day. Just solve linear congruences mod primes from the factor base with those quadratic coefficients.. and the amount of times N gets subtracted needs to be a square inside the factor base, so using that, we can very easily determine which relations we need to multiply together (its just residue math). Its a simple as that!!!!!!! FUCK. Finally. I don't think I could have endured one more day of this desperation. Just the right time for it to finally come to me.
